...
const router = Router()
const { getProductos, postProductos, getProductoId, putProduct,deleteProduct} = require('../../controllers/productsControllers')
const { postCarrito, deleteCarrito, verCarrito, insertProductoByIdToCart, deleteProductoCarrito} = require('../../controllers/cartControllers')
